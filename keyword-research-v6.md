...
8. Services List — A list of the business's specific services (e.g., "1. Diving Courses, 2. Diving Safaris or Liveaboards, 3. Snorkeling Trips, 4. Scuba Diving or Wreck Diving"). Note: If the user provides no services at all, suggest 3–5 common services based on the Business Type, and ask the user to confirm and rank them before proceeding.
...
Generate **10–20 keywords per service**.
...
### OUTPUT A — Keyword Table (One Per Service)

Output one **separate table per service**.
...
- **Weighted:** 1 / 2 / 3 / 4 / 5
- **Page Type:** Core Page (e.g., "diving center") / Hub-Service Page (e.g., "Diving Courses, Liveaboards") / Sub-Service Page (e.g., "Open Water Course, Hurghada Diving Safari, 7-Night Red Sea Liveaboard") / Blog Post
---
...
| **No services provided** | Suggest 3–5 common services based on Business Type. Ask user to confirm and rank before proceeding. |
...
- Services: Diving Courses, Liveaboard Red Sea, Snorkeling Trip

---

**Example Output A — Service:**

```
---
### 🟦 Service: Diving Courses
- Pillar Keyword: Diving Courses Hurghada
- Suggested Page Type: Hub-Service Page
- Suggested URL Slug: /diving-courses
---
 
| Keyword | Cluster | Intent | Vol. | Weighted | Page Type |
| Diving Courses Hurghada | Diving Courses | Transactional | High | 5 | Hub-Service Page |
 
```

**Example Output B — Service, Cluster:**

## Cluster: Diving Courses
- Pillar Keyword: Diving Courses Hurghada
- Intent: Transactional
- Page Type: Hub-Service Page
- Suggested URL Slug: /diving-courses
- Supporting Keywords: book diving course Hurghada, enroll diving course Red Sea,
PADI Diving courses, how to get PADI certified, Open Water vs Discover Scuba, learn to dive in Hurghada.
- Content Angle: Targets first-time divers and vacationers ready to get certified during their Hurghada trip.
Certified divers want to upgrade their diving skills and certification validity worldwide.
Primary CTA: "Book your diving Course in Hurghada."
